...
const std::unordered_map<TypeApiRequest, ChekParam> CHECK_LIST_FOR_REQUEST{
    ...
    , {TypeApiRequest::Records, {WaitingMethod::GET_HEAD, CheckToken::No}}
};
...
public:
    ...
    StringResponse RequestRecords(const StringRequest& req, std::map<std::string, std::string> params);
private:
