...
void SetDogSpeed(model::Map& map, const model::Game& game, const boost_json::JsonValue& jmap){
...
void SetBagCapacity(model::Map& map, const model::Game& game, const boost_json::JsonValue& jmap){
...
void SetLootTypesCount(model::Map& map, const model::Game& game, const boost_json::JsonValue& jmap
...
void SetParamsForGameModel(model::Game& game, const boost_json::JsonValue& json_obj) {
...
void LoadGame(model::Game& game, const std::filesystem::path& json_path, extra_data::ExtraData& ext_data) {
    ...
    for(const auto& jmap : jmaps){
        ...
        SetLootTypesCount(map, game, jmap, ext_data);
